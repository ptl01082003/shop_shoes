...
interface KieuDangCreationAttributes extends Optional<KieuDangAttributes, "id"> {}

class KieuDang extends Model<KieuDangAttributes, KieuDangCreationAttributes> implements KieuDangAttributes {
  public id!: string;
  public Ten?: string;
  public NgayTao?: Date;
