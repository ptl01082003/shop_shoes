...
interface XuatXuCreationAttributes extends Optional<XuatXuAttributes, "id"> {}

class XuatXu extends Model<XuatXuAttributes, XuatXuCreationAttributes> implements XuatXuAttributes {
  public id!: string;
  public Ten?: string;
  public NgayTao?: Date;
