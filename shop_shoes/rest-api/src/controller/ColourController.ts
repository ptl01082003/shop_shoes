...
const ColourController = {
  getColour: async (req: Request, res: Response) => {
    try {
  ...
  //// lấy id
  getColourById: async (req: Request, res: Response) => {
    const { id } = req.params;
  ...
  updateColour: async (req: Request, res: Response) => {
    console.log("createColour called");
    try {
      const { id } = req.params;
      console.log("id :", id);
  ...
  // Xóa một thương hiệu
  deleteColour: async (req: Request, res: Response) => {
    console.log("createColour called");
    try {
      const { id } = req.params;
      const colour = await Colour.findByPk(id);
